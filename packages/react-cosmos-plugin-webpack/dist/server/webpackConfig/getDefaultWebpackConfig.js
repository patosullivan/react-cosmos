...
export function getDefaultWebpackConfig(userWebpack, rootDir) {
    ...
    const babelLoaderPath = resolveFromSilent(rootDir, 'next/dist/compiled/babel-loader') ||
    ...
    const webpack4 = userWebpack.version && parseInt(userWebpack.version, 10) >= 4;
    if (!webpack4) {
        return config;
    }
    return {
